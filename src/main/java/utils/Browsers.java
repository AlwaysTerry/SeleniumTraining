	...
	public Browsers(BrowsersType browserstype){
		switch(browserstype){
		    case firefox:
		    	...
		    	File firebug = new File(projectpath+"\\src\\main\\resources\\firebug-1.12.1-fx.xpi");
			    File firepath = new File(projectpath+"\\src\\main\\resources\\firepath-0.9.7-fx.xpi");
		    ...
		    if(nodeurl.equals(""))
				...
				break;
		    case ie:	
		    	System.setProperty("webdriver.ie.driver", projectpath+"\\src\\main\\resources\\IEDriverServer32.exe"); 
