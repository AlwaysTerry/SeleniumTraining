...
public class TestLinkAPIObject {
	private static Logger logger = Logger.getLogger(TestLinkAPIObject.class);
   ...
   public  TestLinkAPIObject(String url,String devKey,String projectName,String planName,String buildName,String platformName){
	   this.url = url;
	   this.devKey = devKey;
    ...
    public static void main(String args[]){
    	...
    	TestLinkAPIObject testlinkapi = new TestLinkAPIObject(url,devKey,projectName,tl,buildName,platform);
    	testlinkapi.getAPI();
    	testlinkapi.getTestCases();
    	
    	testlinkapi.executeTestCase("case1",2,"The test case is passed on 8.30");
    	testlinkapi.uploadAttchment("C:\\12\\Autor-luter2.jpg");
